// Minimal implementation of 3-server multi-party shuffle DP protocol
...
mod tests {
    ...
    async fn test_protocol_creation() {
        ...
        let protocol = MinimalProtocol::new(config);
    ...
    async fn test_protocol_execution() {
        ...
        let mut protocol = MinimalProtocol::new(config).unwrap();
