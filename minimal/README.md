# Minimal: 3-Server Multi-Party Shuffle DP Protocol
...
This minimal implementation demonstrates a novel approach to shuffle differential privacy that achieves:
